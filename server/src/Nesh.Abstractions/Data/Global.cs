...
namespace Nesh.Abstractions.Data
{
    public static class Global
    {
        ...
        public const int    PROTO_TYPE_NUID        = PROTO_TYPE_STRING   + 1;
        public const int    PROTO_TYPE_ENTITY      = PROTO_TYPE_NUID     + 1;
        public const int    PROTO_TYPE_BYTES       = PROTO_TYPE_ENTITY   + 1;
        public const int    PROTO_TYPE_LIST        = PROTO_TYPE_BYTES    + 1;
        ...
        public const int    PROTO_TABLE_KEY_VALUES = PROTO_TABLE_NAME    + 1;
        #endregion

        public const string MARK_UNIQUE = "unique";
        public const string MARK_ORIGIN = "origin";
        public const string MARK_PRIMARY_KEY = "primary_key";
